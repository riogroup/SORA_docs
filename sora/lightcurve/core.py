...
class LightCurve:
    ...
    **kwargs: `int`, `float`
    ...
    def normalize(self, poly_deg=None, mask=None, flux_min=0.0, flux_max=1.0, plot=False):
        ...
        flux_min : `int`, `float`
            Event flux to be setted as 0.
        
        flux_max : `int`, `float`
            Baseline flux to be setted as 1.
    ...
    def occ_model(self, immersion_time, emersion_time, opacity, mask, npt_star=12,
        ...
        The modelled light curve takes into account the fresnel difraction, the 
        star diameter and the intrumental response.
    ...
    def __occ_model(self, immersion_time, emersion_time, opacity, mask, npt_star=12,
        ...
        Returns the modelled light curve considering fresnel difraction, star 
        diameter and intrumental response, intended for fitting inside the 
        `self.occ_lcfit()`.
