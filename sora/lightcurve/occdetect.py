...
def occ_detect(flux, dflux, time, cycle, maximum_duration=None, dur_step=None, 
                snr_limit=None, n_detections=None, plot=False):
...
def run_bls(flux, dflux, time, per_grid, dur_grid, mask=None, rank=None):
    """Finds the best box fit suitable to the data.
    """
...
def summarize_bls(dict1, dict2):
    """Merges dictionaries returned by BLS and keep values of common keys in list.
    """
    dict3 = {}
