...
class Star(MetaStar):
    ...
    def __init__(self, catalogue='gaiaedr3', **kwargs):
        ...
        Parameters:
            catalogue (str): The catalogue to download data. It can be 'gaiadr2' 
              or 'gaiaedr3'.
            code (str): Gaia Source code for searching in VizieR.
            coord (str, SkyCoord): if code is not given, coord nust have the 
              coordinates RA and DEC of the star to search in VizieR: 
            ...
            rad_vel (int, float): Radial Velocity, in km/s (Default: 0).
            epoch (str, Time): Epoch of the coordinates (Default: 'J2000').
            nomad (bool): If true, it tries to download the magnitudes from 
              NOMAD catalogue (Default: True).
            bjones (bool): If true, it uses de star distance from Bailer-Jones 
              et al. (2018) (Default = True).
            verbose (bool): If true, it prints the downloaded information 
              (Default: True).
    ...
    def set_magnitude(self, **kwargs):
        ...
        Parameters:
            (band name)=(float): The star magnitude for given band. The band 
              name can be any string the user wants.
    ...
    def __searchgaia(self, catalog):
        ...
        Parameters:
            catalog (str): The catalogue to download data. It can be 'gaiadr2' 
              or 'gaiaedr3'.
    ...
    def geocentric(self, time):
        ...
        Parameters:
            time (float, Time): reference time to apply proper motion and 
              calculate paralax.
